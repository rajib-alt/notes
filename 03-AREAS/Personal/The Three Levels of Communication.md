...
```mermaid
graph TD
    A[Rookie\nUnconscious Incompetence] --> B[Pretty Good\nConscious Competence]
    B --> C[Natural\nUnconscious Competence]
    C --> D[Full Range: Voice + Body + Words\nDeployed Automatically]
```

![Communication levels and skill progression](https://source.unsplash.com/800x400/?communication,speaking,presentation)
...
```mermaid
flowchart TD
    A[Has Range Available] --> B{Uses Full Range?}
    B -->|No — Fear of Judgment| C[Stays Pretty Good]
    B -->|Yes — Plays at Edges| D[Moves Toward Natural]
```

![Communicator playing it safe on stage](https://source.unsplash.com/800x400/?speaker,stage,presentation)
...
![Voice modulation and communication dynamics](https://source.unsplash.com/800x400/?voice,microphone,speaking)
...
```mermaid
flowchart LR
    A[Face — Emotion Expressed] --> C[Audience Feels the Message]
    B[Voice — Emotion in Tone] --> C
```
