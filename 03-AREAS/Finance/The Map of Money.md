...
![Stone money and ancient trade](https://source.unsplash.com/800x400/?stone,ancient,currency)
...
timeline
    ...
    5000 BCE : Mesopotamian clay debt tablets
    700 BCE  : First coins (Lydia, modern Turkey)
    1000 CE  : Chinese paper money (Song Dynasty)
    1694 CE  : Bank of England founded
    1944 CE  : Bretton Woods gold standard
    1971 CE  : Nixon ends gold convertibility
```
...
![Old bank vault and paper currency history](https://source.unsplash.com/800x400/?bank,vault,history)
...
```mermaid
flowchart TD
    A[Gold & Silver Coins] --> B[Paper Receipts for Gold]
    B --> C[Central Bank Notes — partially backed]
    C --> D[Bretton Woods — dollar backed by gold]
    D --> E[Nixon Shock 1971 — pure fiat]
    E --> F[Today — digital money created by private banks]
```
...
![Digital banking and money creation](https://source.unsplash.com/800x400/?banking,digital,finance)
